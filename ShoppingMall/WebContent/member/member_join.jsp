...
<script>
	function check(){
		...
		var fomrs = document.getElementById("joinform");
		...
		if((forms.MEMBER_ZIPCODE1.value == "") || (fomrs.MEMBER_ZIPCODE1.value.length<3)){
...
<body>
<table width="960" cellspacing="0" cellpadding="0" boder="0" align="center">
	<tr>
	<td colspan=2>
	<!-- 회원가입 -->
	...
	<tr>
		...
		<td>
			...
			<input type="password" name="MEMBER_JUMIN2" size="12" onkeypress="gNumCheck()" maxlength="7"/>
		</td>
	</tr>
